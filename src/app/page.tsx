  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-[#050508] px-6">
      ...
      <div className="relative w-full max-w-xl">
        {/* Logo mark — gradient kept here intentionally */}
        <div className="mb-12 flex flex-col items-center text-center">
          <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 shadow-lg shadow-indigo-500/20">
          ...
          <h1 className="text-4xl font-bold tracking-tight text-white md:text-5xl">
            Code<span className="text-indigo-400">Timeline</span>
          </h1>
